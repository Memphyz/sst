...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "Risk Identification and Assessment resource")
@EqualsAndHashCode(callSuper = true)
public class IARResource extends AbstractModelAuditableResource<IAR, IARResource, String> {
