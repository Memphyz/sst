package com.sst.resources.psst;
...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "PSST Resource model")
@EqualsAndHashCode(callSuper = true)
public class PSSTResource extends AbstractModelAuditableResource<PSST, PSSTResource, String> {
